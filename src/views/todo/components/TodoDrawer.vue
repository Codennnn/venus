  ...
  >
    <template #title>
      <div class="flex items-center">
        ...
        >
          <feather class="mr-1" size="18" type="check" />
          设为已完成
        </div>
        <div class="ml-auto flex items-center text-gray-600">
          <feather class="ml-2 cursor-pointer" size="18" type="link" />
          <a-dropdown :trigger="['click']">
            <feather class="ml-2 cursor-pointer" size="20" type="more-vertical" />
            <template #overlay>
              <a-menu>
                <a-menu-item
                  v-for="({ text }, i) in [
          ...
          <feather class="ml-2 cursor-pointer" size="21" type="x" @click="onCloseDrawer" />
        </div>
      </div>
    </template>
    <!-- 标题信息 -->
    ...
    <div class="sec">
      ...
      <a-range-picker v-model="currTodo.date" class="w-full" />
    </div>
