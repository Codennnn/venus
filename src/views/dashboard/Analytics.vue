            ...
            <div class="dashboard-card flex flex-col justify-between">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <div class="flex items-center">
                    60%
                    <feather class="success ml-1" size="14" type="trending-up" />
                  </div>
                </div>
        ...
        <div class="flex">
          ...
          <div class="w-1/2 pl-3 flex flex-col">
            <div class="dashboard-card mb-6 flex-1 flex items-center">
              <div
                style="min-width: 2.5rem; background: rgba(var(--primary), 0.18)"
            ...
            <div class="dashboard-card flex-1 flex items-center">
              <div
                style="min-width: 2.5rem; background: rgba(var(--warning), 0.18)"
                class="h-10 flex items-center justify-center warning rounded-full"
              >
                <feather size="18" type="dollar-sign" />
              </div>
              <div class="mx-4 whitespace-no-wrap">
          ...
          <div class="dashboard-card flex-1">
            ...
            <div class="flex items-end justify-between">
              <div>
                ...
                <feather class="success -mb-1" size="18" type="trending-up" />
        ...
        <div class="w-1/2 pr-3">
          <div class="dashboard-card">
            ...
            <div class="py-6 flex items-center">
              <feather class="primary mr-3" type="arrow-up-circle" />
              <div>
                <div>销量最佳</div>
            ...
            <div class="flex items-center">
              <feather class="text-gray-500 mr-3" type="arrow-down-circle" />
              <div>
                <div>销量最低</div>
    ...
    <section class="row">
      <div class="w-3/5 pr-3">
        <div class="dashboard-card p-0">
          <div style="border-bottom: 1px solid #eee" class="mb-2 px-6 py-4 flex items-center">
            ...
            <div class="ml-auto flex items-center">
              <a-dropdown class="mr-6">
                ...
                <template #overlay>
                  <a-menu>
                    <a-menu-item> 已完成 </a-menu-item>
                    <a-menu-item> 带完成 </a-menu-item>
                    <a-menu-item> 已丢弃 </a-menu-item>
                  </a-menu>
                </template>
              </a-dropdown>
              <a-dropdown>
          ...
          <ul>
            ...
            >
              ...
              <a-dropdown>
                ...
                <template #overlay>
                  <a-menu>
                    <a-menu-item class="flex items-center" @click="editTodo(id)">
                      <feather class="mr-2 cursor-pointer" size="16" type="edit" />
                      编辑
                    </a-menu-item>
                    <a-menu-item class="flex items-center" @click="editTodo(id)">
                      <feather class="mr-2 cursor-pointer" size="16" type="trash" />
                      删除
                    </a-menu-item>
                  </a-menu>
                </template>
        ...
        <div class="dashboard-card">
          ...
          <a-timeline class="timeline">
            ...
            >
              <template #dot>
                <div
                  style="box-shadow: 1px 2px 6px 0 rgba(25, 42, 70, 0.3)"
