  ...
  <div>
        ...
        <div class="dashboard-card">
          ...
          <div class="flex items-end">
            <div class="w-1/2 mr-4">
              ...
              <p class="mb-2 text-gray-600">您今日已完成<br />57.6% 的销售额</p>
              <a-button size="large" type="primary"> 查看销售记录 </a-button>
            </div>
            <div class="flex-1">
              <img class="w-full" src="@img/cup.png" alt="cup" />
            </div>
          </div>
        </div>
      </div>
      <div class="w-1/3 px-3">
        <div class="dashboard-card">
          ...
          <ul class="flex items-center justify-around">
            ...
            >
              <span class="inline-block w-2 h-2 rounded-full mr-2" :class="`bg-${color}`" />
              {{ label }}
            </li>
          </ul>
        </div>
      ...
      <div class="w-1/3 pl-3 flex flex-col">
        <div class="flex mb-6">
          ...
          <div class="dashboard-card dashboard-card-icon">
            ...
            <div>新用户</div>
            <div class="text-2xl font-semibold">45.6k</div>
          </div>
        </div>
    ...
    <section class="row">
      <div class="w-2/3 pr-3">
        <div style="padding: 0.5rem 0" class="dashboard-card flex">
          <div style="border-right: 1px solid #dedede" class="flex-1 flex flex-col overflow-hidden">
            <h3 class="dashboard-card-title px-6 py-4">
              订单概况
              <div>
                <a-button class="mr-4"> 月度 </a-button>
          ...
          <div class="w-1/3">
            <div style="border-bottom: 1px solid #eee">
              <h3 class="card-title px-6 py-4">销售记录</h3>
              <ul class="px-6">
                <li
            ...
            <div class="p-6">
              <h3 class="dashboard-card-title">总销售额</h3>
              <div class="primary mt-1 text-lg font-semibold">￥82,950.9</div>
              <a-progress :show-info="false" :percent="75" />
            </div>
          </div>
        </div>
      </div>
          ...
          <h3 class="dashboard-card-title px-6 py-3">
            ...
            <a-dropdown>
              <div class="flex items-center text-base text-gray-500 font-semibold cursor-pointer">
                2020
                <feather class="ml-1" size="20" type="chevron-down" />
              </div>
              <template #overlay>
                <a-menu>
                  <a-menu-item> 2020 </a-menu-item>
                  <a-menu-item> 2019 </a-menu-item>
                  <a-menu-item> 2018 </a-menu-item>
                </a-menu>
              </template>
            </a-dropdown>
          </h3>
          ...
          <ul>
            ...
            >
              ...
              <a-progress
                ...
                :percent="percent"
              />
              <a-tag class="ml-auto" :color="`rgba(var(--${color}), .9)`"> ￥{{ sales }} </a-tag>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="dashboard-card p-0">
          <h3 class="dashboard-card-title mb-2 px-6 py-3">
            ...
            <a-button class="flex items-center">
              <span>查看报告</span>
              <feather size="20" type="chevron-right" />
            </a-button>
          </h3>
          <div>
            <a-table
      ...
      tableDataSource: [
        {
          ...
          charge: 5536,
          status: 1,
          trademark: require('@img/trademark/mi.png'),
        },
        {
          id: '2',
          campaign: '麦当劳汉堡包',
          ...
          charge: 12897,
          status: 2,
          trademark: require('@img/trademark/mdn.png'),
        },
        {
          id: '3',
          campaign: '耐克 Air Jordan',
          growth: -70.3,
          charge: 23859,
          status: 2,
          trademark: require('@img/trademark/nike.png'),
        },
        {
          id: '4',
          campaign: 'Oneplus 7 pro',
          growth: 70.3,
          charge: 23859,
          status: 1,
          trademark: require('@img/trademark/oneplus.png'),
        },
        {
          id: '5',
          campaign: '华为 Mate 30',
          ...
          charge: 23859,
          status: 1,
          trademark: require('@img/trademark/huawei.png'),
        },
      ],
    }
  },
