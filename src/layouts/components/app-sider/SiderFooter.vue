<template>
  <div class="flex items-center justify-center">
    <div class="relative w-2/3 h-10">
      ...
      >
        <div class="w-full flex items-center justify-center" :class="isTaskOpen ? 'h-12' : 'h-10'">
          <feather class="mx-3" size="21" type="layers" />
        ...
        <div v-show="isTaskOpen" class="p-5">
          ...
          >
            <li
              v-for="{ title, sub } in [
                ...
                {
                  title: '是唐朝诗人白居易',
                  sub: '主人下马客在船，举酒欲饮无管弦。醉不成欢惨将别，别时茫茫江浸月。',
                },
        ...
        <div v-show="isTaskOpen">
          <div class="progress-grid">
            ...
            >
              <div>{{ label }}</div>
              <a-progress class="mt-0" :stroke-color="color" :percent="percent" />
            </div>
          </div>
        </div>
